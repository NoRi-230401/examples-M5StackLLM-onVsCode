...
VsCode環境で M5Stack LLM-Module のサンプル動作の確認ができるようにしたものです。<br>


## examples

次のリンク先のexamplesをちょっとだけ修正<br>
...
SerialTextAssistantを日本語表示に対応にしたものを新規に追加<br>
...
## 対応機種
LLM-Moduleと繋ぐ機種は、次の３種に対応しています。<br>
...
BASIC および CoreS3の機種は実機確認をおこなっていませんのでご了承ください。<br>

## SD-Updater対応
M5Stack Core2(Ver1.0 and AWS) のみですが、SD_Uploder対応版用にコンパイルできます。<br>
VsCodeの下部の「Switch PlatformIO Project enviroment」で選択してご使用ください。<br>
